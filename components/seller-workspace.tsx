...
const UZUM_MARKET_PROMPT = "Uzum Market uslubidagi toza mahsulot fotosi: mahsulotni aynan o'zidek saqla, fonni sof oq studiya foniga almashtir. Mahsulot markazda, yumshoq bir tekis yorug'lik va tabiiy soya bilan, boshqa buyum, matn yoki bezaksiz."
