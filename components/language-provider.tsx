...
const dictionaries: Record<Language, Dictionary> = {
  uz: {
    ...
    gallery: 'Galereya', galleryDesc: 'Yaratilgan barcha fotolaringiz shu yerda saqlanadi.', noPhotos: 'Hali foto yo‘q. Studioda birinchi fotoni yarating.',
  ...
  ru: {
    ...
    gallery: 'Галерея', galleryDesc: 'Все созданные фотографии хранятся здесь.', noPhotos: 'Фотографий пока нет. Создайте первую в студии.',
